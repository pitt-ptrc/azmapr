...
azm_maps_base_url <- "https://atlas.microsoft.com/search/address/batch/sync/json?api-version=1.0&subscription-key="
...
get_azm_url <- function() {
  ...
  if (nzchar(api_key)) {
    ...
    stop("Azure Maps API Subscription Key not found in your environment variables. \n",
         ...
         "Sys.setenv(azm_MAPS_SUBSCRIPTION_KEY = 'your_key_here')")
  }
}
